    ...
    $links = [
        ...
        [
            ...
            'href' => [
                ...
                [
                    'section_text' => 'Data Kriteria',
                    'section_icon' => 'far fa-circle',
                    'section_href' => route('kriteria.index'),
                ],
                [
                    'section_text' => 'Data Kuisioner',
                    'section_icon' => 'far fa-circle',
                    'section_href' => route('kuisioner.index'),
                ],
                [
                    'section_text' => 'Data Alternatif',
                    'section_icon' => 'far fa-circle',
                    'section_href' => route('kuisioner.index'),
                ],
                [
                    'section_text' => 'Data Responden',
                    'section_icon' => 'far fa-circle',
                    'section_href' => route('kuisioner.index'),
                ],
            ],
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <span class="brand-image img-circle elevation-3 "><i class="nav-icon fas fa-home"></i></span>
        <span class="brand-text font-weight-light">Sistem Promosi Kampus</span>
    </a>
