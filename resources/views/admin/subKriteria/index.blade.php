        ...
        <div class="row">
            @if (session('status'))
                <div class="alert alert-success alert-dismissible">
                    <button type="button" class="close btn btn-danger" data-dismiss="alert" aria-hidden="true">×</button>
            ...
            <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            {{-- <h4 class="card-title col-6">Data Kriteria</h4> --}}
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <h3 class="card-title col-3">
                                <a href="{{ route('subKriteria.create') }}" class="btn btn-sm btn-success"> + Tambah Sub
                                    Kriteria</a>
                            ...
                            <tbody>
                                @foreach ($sub as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->kriteria->nama_kriteria }}</td>
                                        <td>
                                            <a href="{{ route('subKriteria.edit', $data->id) }}"><i
                                                    class='fas fa-edit fa-lg'></i></a>
                                            <a style='border: none; background-color:transparent;'
                                                href="{{ route('subKriteria.delete', $data->id) }}">
                                                <i class='fas fa-trash fa-lg text-danger'></i></a>
                                        </td>
                                    <tr>
                                @endforeach
