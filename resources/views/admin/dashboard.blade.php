                            ...
                            <div class="row">
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
                                        ...
                                        <p class="text-xs mt-1 mb-0 font-weight-bold">{{ $sosial_media->nama_alternatif }}
                                        </p>
                                    </div>
                                    <h4 class="font-weight-bolder"> {{ number_format($sosial_media->rata_rata_hasil, 3) }}
                                    </h4>
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            aria-valuenow="{{ number_format($sosial_media->rata_rata_hasil, 3) }}"
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{ number_format($website->rata_rata_hasil, 3) * 1000 }}% !important"
                                            aria-valuenow="{{ number_format($website->rata_rata_hasil, 3) }}"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark " role="progressbar"
                                            aria-valuenow="{{ number_format($berjumpa->rata_rata_hasil, 3) }}"
                                ...
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
                                        ...
                                        <p class="text-xs mt-1 mb-0 font-weight-bold">{{ $media_cetak->nama_alternatif }}
                                        </p>
                                    </div>
                                    <h4 class="font-weight-bolder">{{ number_format($media_cetak->rata_rata_hasil, 3) }}
                                    </h4>
                                    <div class="progress w-75">
                                        <div class="progress-bar bg-dark " role="progressbar"
                                            aria-valuenow="{{ number_format($media_cetak->rata_rata_hasil, 3) }}"
