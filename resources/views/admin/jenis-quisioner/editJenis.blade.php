...
@section('content')
    <section class="content">
        ...
        @endif
        <form method="post" action="{{ route('jenis-kuis.update', $jenis->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="id_quisioner" value="{{ $jenis->quisioner->question }}"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success float-right">Update Jenis </button>
                        </div>
                        <!-- /.card-body -->
